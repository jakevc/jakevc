...
date: '2020-05-01'
tags: ['aws', 'elasticbeanstalk', 'golang']
draft: false
summary: 'Building and deploying a golang webapplication on AWS elasticbeanstalk using a single instance environment without a load balancer'
---
